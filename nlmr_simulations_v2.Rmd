...
map2(.x = analyses$exposures[11:20], .y = analyses$outcomes[11:20], seed = 2324, reps = 50, .f = generate_outcome_plots_u_replicates)
```
...
map2(.x = analyses$exposures[11:25], .y = analyses$outcomes[11:25], seed = 2021, reps = 50, .f = generate_outcome_plots_thresh_replicates)
...
```{r}
map2(.x = analyses$exposures, .y = analyses$outcomes, seed = 2023, reps = 50, .f = generate_outcome_plots_linear_replicates_thresh_iv)
```
...
d <- sim_mydata_outcomes_thresh_iv(n = 100000, seed = 12)
