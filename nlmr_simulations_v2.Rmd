...
## make figures
ss
myplot = generate_plots(ss_data = ss, simdata = test, exposure = "x_beta", outcome = "y_exp", distribution_type = "beta")
myplot
## print to file
pdf(file = "figures/Simulated_Gene_Outcome_Beta_Data.pdf", width = 13, height = 40)
myplot
dev.off()
