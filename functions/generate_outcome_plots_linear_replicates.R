generate_outcome_plots_linear_replicates <- function(exposure, outcome, seed = "123", reps = 10) {
  ...
  ggsave(master_plot, filename = paste0("figures/linear/", exposure,"_",outcome,"_linear_effect_", reps,"_reps.pdf"), width = 14, height = 22)
}
