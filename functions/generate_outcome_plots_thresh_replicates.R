generate_outcome_plots_thresh_replicates <- function(exposure, outcome, seed = "123", reps = 10) {
  ...
  seed = seed + n_rep
  dat <-  sim_mydata_outcomes_thresh(n = 25000, seed = seed)
  ...
  dat <-  sim_mydata_outcomes_thresh(n = 100000, seed = seed)
  ...
  ggsave(master_plot, filename = paste0("figures/thresh/", exposure,"_",outcome,"_thresh_effect_", reps,"_reps.pdf"), width = 13, height = 24)
}
